...
fig/diagrama_segundo_nivel.png
...
Bloques mínimos: registro del PC; sumador PC+4; lógica de cálculo de direcciones de salto; decodificador de instrucciones; unidad de control; banco de registros; generador de inmediatos; ALU; comparador de bifurcaciones; multiplexores de operando A, operando B y escritura al banco de registros; multiplexor de selección del siguiente PC; interfaz con memoria de datos y periféricos. Debe mostrar los buses principales, sus anchos y las señales de control del datapath.
